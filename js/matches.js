...
const ALT_CHANNELS = [
  { label:'FIFA+ (EN)', url:'https://jmp2.uk/plu-660c29b5aec9680008f5b4a4.m3u8',
    note:'720p, official FIFA stream' },
  { label:'FIFA+ (US)', url:'https://d2w9q46ikgrcwx.cloudfront.net/v1/master/3722c60a815c199d9c0ef36c5b73da68a62b09d1/cc-of5cbk3sav3w5/v1/sysdata_s_p_a_fifa_7/samsungheadend_us/latest/main/hls/playlist.m3u8',
    note:'720p, geo US' },
  { label:'Alkass 1', url:'https://liveeu-gcp.alkassdigital.net/alkass1-p/main.m3u8',
    note:'Qatar — HD' },
  { label:'Alkass 2', url:'https://liveeu-gcp.alkassdigital.net/alkass2-p/main.m3u8',
    note:'Qatar — HD' },
  { label:'Alkass 3', url:'https://liveeu-gcp.alkassdigital.net/alkass3-p/main.m3u8',
    note:'Qatar — HD' },
  { label:'Alkass 4', url:'https://liveeu-gcp.alkassdigital.net/alkass4-p/main.m3u8',
    note:'Qatar — HD' },
  { label:'Alkass 5', url:'https://liveeu-gcp.alkassdigital.net/alkass5-p/main.m3u8',
    note:'Qatar — HD' },
  { label:'KSA Sports 1', url:'https://aloula-redirect.vercel.app/9/playlist.m3u8',
    note:'Saudi — HD' },
  { label:'KSA Sports 2', url:'https://aloula-redirect.vercel.app/10/playlist.m3u8',
    note:'Saudi — HD' },
  { label:'KSA Sports 3', url:'https://aloula-redirect.vercel.app/16/playlist.m3u8',
    note:'Saudi — HD' },
  { label:'Arryadia', url:'https://stream-lb.livemediama.com/arryadia/hls/master.m3u8',
    note:'Morocco — HD' },
  { label:'TVRI Sport', url:'https://ott-balancer.tvri.go.id/live/eds/SportHD/hls/SportHD.m3u8',
    note:'Indonesia — HD' },
  { label:'Arena Sport 1', url:'https://nl1.nghk.ai/ArenaSport1HD/index.m3u8',
    note:'Balkan — HD' },
  { label:'Arena Sport 2', url:'https://nl1.nghk.ai/ArenaSport2HD/index.m3u8',
    note:'Balkan — HD' },
